...
<p>You can save the configuration of an instance and relaunch it with updated images at a later time by using the <a href:'https://chameleoncloud.readthedocs.io/en/latest/technical/images.html' target='_blank'>cc-snapshot utility</a>
